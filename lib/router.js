...
Router.route('/',{
	...
	waitOn: function(){
		return [Meteor.subscribe("allInterestPoints"), Meteor.subscribe("allSuggestions"), Meteor.subscribe("allCurrencies"), Meteor.subscribe("allLocales")];
	}
});
...
Router.route('/masterdata/others',{
	...
	waitOn: function(){
		return [Meteor.subscribe("allCurrencies"), Meteor.subscribe("allLocales")];
	}	
});
