FlowRouter.route('/', {
	name: 'welcome1',
	action() {
		BlazeLayout.render('mainLayout', {main: 'welcome1'});
	}
});
...
FlowRouter.route('/2', {
	name: 'welcome2',
	action() {
		BlazeLayout.render('mainLayout', {main: 'welcome2'});
	}
});
...
FlowRouter.route('/3', {
	name: 'welcome3',
	action() {
		BlazeLayout.render('mainLayout', {main: 'welcome3'});
	}
});
...
FlowRouter.route('/masterdata/trips',{
	name:'masterdata_trips',
	action(){
		BlazeLayout.render('mainLayout', {main: 'masterdata_trips'})
	}
});

FlowRouter.route('/masterdata/tripCreation',{
	name:'masterdata_tripCreation',
	action(){
		BlazeLayout.render('mainLayout', {main: 'masterdata_tripCreation'})
	}
});
