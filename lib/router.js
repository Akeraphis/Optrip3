...
Router.route('/',{
	...
	waitOn: function(){
		return [Meteor.subscribe("allInterestPoints"), Meteor.subscribe("allSuggestions"), Meteor.subscribe("allCurrencies")];
	}
});
...
Router.route('/masterdata/fares',{
	...
	waitOn: function(){
		return [Meteor.subscribe("allFlightFares"), Meteor.subscribe("allCarFares"), Meteor.subscribe("allHotelFares"), Meteor.subscribe("allHotels")];
	}	
});
...
Router.route('/masterdata/others',{
	...
	waitOn: function(){
		return Meteor.subscribe("allCurrencies");
	}	
});
